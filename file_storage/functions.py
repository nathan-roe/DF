...
def create_or_update_file(instance, file, file_path):
    """
    Handles the creation and update of an File model instance
    """
    from file_storage.serializers import S3FileAllSerializer
     # create photo
    if instance is None and file:
        profile_photo_serializer = S3FileAllSerializer(data={'file_path': file_path}, context=file)
    ...
    # update photo
        ...
        instance.update_or_delete(file, file_path)
